        ...
        <section className="bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-20 px-4">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg max-w-2xl mx-auto text-primary-foreground/90">
              Have questions? We're here to help with your travel needs
            </p>
          </div>
        </section>
                ...
                <Card>
                  <CardContent className="p-6 flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">support@loveabletravel.com</p>
                      <p className="text-muted-foreground">info@loveabletravel.com</p>
                    </div>
                  </CardContent>
                </Card>
